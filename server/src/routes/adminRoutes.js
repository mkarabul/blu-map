...
router.patch('/:userName/increment-report', UserController.incrementUserReportCount);
router.patch('/:userName/decrement-report', UserController.decrementUserReportCount);

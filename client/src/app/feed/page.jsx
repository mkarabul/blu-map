...
import LocationInterests from "../social/components/LocationInterests";
import SeasonalPreferences from "../social/components/SeasonalPreferences";
import LocationFinder from "../social/components/LocationFinder";
import PlannedTripDetails from "../social/components/PlannedTripDetails";
    ...
    <div className="container mx-auto p-4">
      <div className="flex flex-col md:flex-row mt-20">
        ...
        <div className="flex-1 justify-center mt-0">
          ...
          <ListPosts allPosts={filteredPosts} />
        </div>
